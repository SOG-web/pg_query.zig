...
PgQueryProtobufParseResult pg_query_protobuf_from_raw_parse_result(PgQueryRawParseResult parse_result)
{
	PgQueryProtobufParseResult result = {0};
	...
	result.parse_tree = pg_query_nodes_to_protobuf(parse_result.tree);
	return result;
}
